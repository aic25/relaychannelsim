	...
	for (size_t f_index = 0; f_index < N; f_index++){
		for (n = 1; n < PREAMBLE_LENGTH + 1; n++){
			...
			d[0] = y[0][0] + 
				...
				H[f_index][0][(receiver_index + 1) % 3][0] * wh_sequence[(receiver_index + 1) % 3][np][f_index][0] -
				H[f_index][0][(receiver_index + 1) % 3][1] * wh_sequence[(receiver_index + 1) % 3][np][f_index][1]
				);
			d[1] = y[0][1] +
				(
				...
				H[f_index][0][(receiver_index + 1) % 3][1] * wh_sequence[(receiver_index + 1) % 3][np][f_index][0] +
				H[f_index][0][(receiver_index + 1) % 3][0] * wh_sequence[(receiver_index + 1) % 3][np][f_index][1]
				);
			...
			u[0] = y[1][0] +
				...
				H[f_index][1][(receiver_index + 1) % 3][0] * wh_sequence[(receiver_index + 1) % 3][np][f_index][0] -
				H[f_index][1][(receiver_index + 1) % 3][1] * wh_sequence[(receiver_index + 1) % 3][np][f_index][1]
				);
			u[1] = y[1][1] +
				(
				...
				H[f_index][1][(receiver_index + 1) % 3][1] * wh_sequence[(receiver_index + 1) % 3][np][f_index][0] +
				H[f_index][1][(receiver_index + 1) % 3][0] * wh_sequence[(receiver_index + 1) % 3][np][f_index][1]
				);
