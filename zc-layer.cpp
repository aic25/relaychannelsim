...
void Zadoff_Chu_generator_layer1(double(*transmitted_signal)[Tx][BURST][2]){
...
void Zadoff_Chu_generator_layer2(double(*transmitted_signal)[Tx][BURST][2]){//4
	int i, Nl, utx, n, index, u, m, tx;
	double time_signal[Nf][2];
	double zc_signal_ab[N][2];
	double FFT_signal[N][2], FFT_signal2[Nf][2];
