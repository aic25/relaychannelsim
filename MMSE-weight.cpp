...
void MMSE_Weight_Matrix(double(*H)[Rx][Tx][2], double(*W)[Tx][Rx][2]){
	int rx, tx, tx2, f_index, i;
	double WH[N][Tx][Rx][2];
	double g_i[Tx][2], g_iH[Tx][2], power_i[2], g[Rx][2], gH[Rx][2], power[2], no;
	double HH[Tx][Rx][2], Rt[Tx][Tx][2], I[Tx][Tx][2], R[Tx][Tx][2];
