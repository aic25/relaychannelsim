...
void setting_print(){
	...
	if (MODULATION == QPSK){
		fprintf(fdata, "# mod: QPSK, R=%2.1f, K=7, BS: %d, TS: %d\n", CODING_RATE, BS, TS);
		printf("# mod: QPSK, R=%2.1f, K=7, BS: %d, TS: %d\n", CODING_RATE, BS, TS);
	}
...
#if(CHANNEL_CODING==ON)
	fprintf(fdata, "# Channel Coding: ON\n");
	printf("# Channel Coding: ON\n");
#else
	fprintf(fdata, "# Channel Coding: OFF\n");
	printf("# Channel Coding: OFF\n");
#endif	
...
#else							  
	fprintf(fdata, "# IW3I selection: ON\n");
	printf("# IW3I selection: ON\n");
#endif
#endif
