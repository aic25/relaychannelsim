...
void DF_Combining_Coeff(
	...
	u[0] = received_vector[1][0] -
		(
		H[1][0][0] * reference_symbol[0] -
		H[1][0][1] * reference_symbol[1]
		) -
		(
		H[1][1][0] * reference_symbol_bs3[0] -
		H[1][1][1] * reference_symbol_bs3[1]
		);
	u[1] = received_vector[1][1] -
		(
		H[1][0][0] * reference_symbol[1] +
		H[1][0][1] * reference_symbol[0]
		) -
		(
		H[1][1][0] * reference_symbol_bs3[1] +
		H[1][1][1] * reference_symbol_bs3[0]
		);
	if ((f_index == 5)&&(DBG==ON))cout << "u: " << u[0] << " " << u[1] << endl;
	d[0] = received_vector[0][0] -
		(
		H[0][0][0] * reference_symbol[0] -
		H[0][0][1] * reference_symbol[1]
		) -
		(
		H[0][1][0] * reference_symbol_bs3[0] -
		H[0][1][1] * reference_symbol_bs3[1]
		);
	d[1] = received_vector[0][1] -
		(
		H[0][0][0] * reference_symbol[1] +
		H[0][0][1] * reference_symbol[0]
		) -
		(
		H[0][1][0] * reference_symbol_bs3[1] +
		H[0][1][1] * reference_symbol_bs3[0]
		);
