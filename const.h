...
#define FDr					0.0											 
#define RS_TAU				(0.42)								/*K=10dB*/
#define TAU					(1.44)								/*K=0dB*/
/*---------OFDM and Viterbi---------*/
...
#define Nd					32										/* Number of data packets			*/
...
#ifdef DDWE
#define UD_SELECT
#define E_SELECT													/*undef for w select*/
#endif // DDWE
/*--  CODING  -----------------------------------------------------*/
#define CHANNEL_ENCODING	OFF				
#if CHANNEL_ENCODING
#define CODING_RATE		0.50
#define N_dbps			(int)(N_cbps*CODING_RATE)	/* Coded bps and Data bps */
#else																	
#define CODING_RATE		1.0
#define N_dbps			N_cbps	/* Coded bps and Data bps */  
#define THEORETICAL ON
#endif
