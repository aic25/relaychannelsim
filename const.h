...
#define EbNo_FROM		50		/* Define limits of SNR main loop */
...
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][TS][2], double(*)[TS][BS][2], double(*e)[NUMBER_OF_STEPS][2]);
