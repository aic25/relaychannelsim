...
/*--  EStIMatIon.cPP ----------------------------------------------*/
void ideal_channel_estimation4all_ch(double(*H)[CL][BS][2]);	/* This one estimates ideally */
void ideal_channel_estimation4all_ch_MS2(double(*H)[CL][BS][2]);	/* This one estimates ideally */
void channel_estimation4ZC_4all_ch(double(*received_signal)[BURST][2], double(*H)[CL][BS][2]);	/* ? */
...
/*--  MMSE - dEtecTOR.cpp  ----------------------------------------*/
void CoherentDetection4SD(int receiver_index, int data_number, double(*DFT_signal)[N][2], double(*WH)[KI][CL][2], double(*diLLR)[Nd][N_cbps]);
void CoherentDetection4HD(int receiver_index, int data_number, double(*DFT_signal)[N][2], double(*WH)[KI][CL][2], int(*diLLR)[Nd][N_cbps]);
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[CL][BS][2], double(*)[KI][CL][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[KI][CL][2], double(*)[CL][BS][2]);
void DDWE_Update(int receiver_index, double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e), int f_index);
...
void DFT_forusr3(int, int, double(*)[BURST][2], double(*)[N][2]);
/*--  BER.cpp  ----------------------------------------------------*/
...
/*--------------------MRC.cpp---------------------------------------*/
void mrc_weight(double(*)[CL][BS][2]);
void h_desired(double(*)[CL][BS][2], double(*)[TS][2]);
