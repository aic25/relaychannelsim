...
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][CL][2], double(*)[TS][BS][2], double(*wh_sequence)[Np][N], double(*e)[NUMBER_OF_STEPS][2]);
void DDWE_Update(int R_index, double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e)[NUMBER_OF_STEPS][2], double(*reference_symbol_bs3), int f_index, int);
