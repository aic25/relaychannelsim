...
void transmitter_initialize(double(*)[Tx][BURST][2]);	/* Reset the transmitted_signal[Rx][Tx][BURST][COMPLEX] */
...
/*--  mUlTIPAth.cpp  ----------------------------------------------*/
void multipath_propagation(double(*transmitted_sigmat)[Tx][BURST][2], double(*received_signal)[BURST][2]);	/* Propogates OFDM symbol over multipath channel.											*/
...
void transmitted_signal_Matrix(double(*)[2], double(*)[2], double(*)[2], double(*)[2], double(*)[Tx][BURST][2]);	/* transmitted_signal[Rx][Tx][BURST][COMPLEX] Transmission between BSs and MSs. */
/*--  fFT.Cpp  ----------------------------------------------------*/
...
void Zadoff_Chu_generator_layer1(double(*)[Tx][BURST][2]);	/* Layer one and layer two seems identical */
void Zadoff_Chu_generator_layer2(double(*)[Tx][BURST][2]);	/**/
/*--  EStIMatIon.cPP ----------------------------------------------*/
void ideal_channel_estimation4all_ch(double(*H)[Rx][Tx][2]);	/* This one estimates ideally */
void ideal_channel_estimation4all_ch_MS2(double(*H)[Rx][Tx][2]);	/* This one estimates ideally */
void channel_estimation4ZC_4all_ch(double(*received_signal)[BURST][2], double(*H)[Rx][Tx][2]);	/* ? */
...
void CoherentDetection4HD(int data_number, double(*DFT_signal)[N][2], double(*WH)[Tx][Rx][2], int(*diLLR)[N_cbps]);
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[Rx][Tx][2], double(*)[Tx][Rx][2]);
void MMSE_Weight_Compare(double(*)[Rx][Tx][2], double(*)[Tx][Rx][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, double(*)[Rx][N][2], double(*)[Rx][N][2], double(*)[Tx][Rx][2], double(*)[Rx][Tx][2]);
void DDWE_Update(double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[Tx][2], double(*e), int f_index);
...
/*--------------------MRC.cpp---------------------------------------*/
void mrc_weight(double(*)[TS][Tx][2]);
void h_desired(double(*)[TS][Tx][2], double(*)[TS][2]);
void VectorHermite(double(*)[TS][2], double(*)[TS][2]);
void VectorMulVectorToscalar(double(*a)[TS][2], double(*b)[TS][2], double(*c)[2]);
/*---------------Walsh-Hadamard--------------------------------------*/
void WHadamard_initialize(double(*)[Tx][BURST][2], double(*)[Np][N]);
void WH_channel_estimation(double(*DFT_signal)[Rx][N][2], double(*H)[Rx][Tx][2], double(*)[Np][N]);
...
void MatrixSubMatrixToMatrix(double(*)[Rx][2], double(*)[Rx][2], double(*)[Rx][2]);
...
void MatrixMulVectorToVector(double(*)[Rx][2], double(*)[2], double(*)[2]);
void MatrixMulVectorToVector2(double(*)[Tx][2], double(*)[2], double(*)[2]);
void ScalarMulMatrixToMatrix(double *, double(*)[Rx][2], double(*)[Rx][2]);
...
void VectorMulMatrixToVector(double(*)[2], double(*)[Rx][2], double(*)[2]);
void VectorMulVectorToMatrix(double(*)[2], double(*)[2], double(*)[Rx][2]);
