...
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][CL][2], double(*)[TS][BS][2], double(*wh_sequence)[Np][N], double(*e)[NUMBER_OF_STEPS][2], double(*e_w)[NUMBER_OF_STEPS][2], double(*e_w3)[NUMBER_OF_STEPS][2]);
...
/*--  receiver.cpp  -----------------------------------------------*/
void receiver(int(*_Rindex), double(*Received_Signal)[BURST][2], double(*Received_Signal_wonoise)[BURST][2], int(*rbit)[Nd][N_dbps], double(*wh_sequence)[Np][N]);
