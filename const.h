...
void DDWE_Update(double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e), double(*reference_symbol_bs3), int f_index);
...
/*--  BER.cpp  ----------------------------------------------------*/
void BER(int loop, int(*tbit)[Nd][N_dbps], int(*rbit)[Nd][N_dbps]);				
/*-------------------- RELAY 1 -------------------------------------*/
