...
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][TS][2], double(*)[TS][BS][2], double(*wh_sequence)[Np][N][2], double(*e)[NUMBER_OF_STEPS][2]);
...
/*--  receiver.cpp  -----------------------------------------------*/
void receiver(double(*Received_Signal)[BURST][2], int(*rbit)[Nd][N_dbps], double(*wh_sequence)[Np][N][2]);
