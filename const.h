...
void CoherentDetection4HD(int data_number, double(*DFT_signal)[N][2], double(*WH)[BS][CL][2], int(*diLLR)[N_cbps], int(*Decision));
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[TS][BS][2], double(*)[BS][TS][2]);
void MMSE_Weight_Compare(double(*)[TS][BS][2], double(*)[BS][TS][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][CL][2], double(*)[TS][BS][2], double(*wh_sequence)[Np][N]);
void DDWE_Update(double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e), int(*Decision), int f_index);
...
/*--  receiver.cpp  -----------------------------------------------*/
void receiver(double(*Received_Signal)[BURST][2], int(*rbit)[N_dbps], double(*wh_sequence)[Np][N]);
