...
void CoherentDetection4HD(int(*R_index), int data_number, double(*DFT_signal)[N][2], double(*WH)[4][4][2], int(*diLLR)[Nd][N_cbps], int(*Decision));
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[TS][BS][2], double(*)[BS][TS][2]);
void MMSE_Weight_Compare(double(*)[TS][BS][2], double(*)[BS][TS][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[4][4][2], double(*)[TS][BS][2], double(*wh_sequence)[Np][N], double(*e)[NUMBER_OF_STEPS][2], double(*e_w)[NUMBER_OF_STEPS][2], double(*e_w3)[NUMBER_OF_STEPS][2]);
void DDWE_Update(int(*Decision), int R_index, double(*received_vector)[2], double(*reference_symbol), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e)[NUMBER_OF_STEPS][2], double(*e_w)[NUMBER_OF_STEPS][2], double(*e_3)[NUMBER_OF_STEPS][2], double(*reference_symbol_bs3), int f_index, int);
...
/*--  receiver.cpp  -----------------------------------------------*/
void receiver(int(*_Rindex), double(*Received_Signal)[BURST][2], int(*rbit)[Nd][N_dbps], double(*wh_sequence)[Np][N]);
...
void VectorMulVectorToMatrix(double(*v1)[2], double(*v2)[2], double(*a)[4][2]);
