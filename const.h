...
/*--  matrix_cl.cpp  -------------------------------------------------*/
void MatrixInverse_CLxCL(double(*a)[BS][2]);
void MatrixHermite_CLxCL(double(*m1)[BS][2], double(*m2)[TS][2]);
void MatrixTranspose_CLxCL(double(*m1)[BS][2], double(*m2)[TS][2]);
void MatrixAddMatrixToMatrix_CLxCL(double(*a)[BS][2], double(*b)[BS][2], double(*c)[BS][2]);
void MatrixSubMatrixToMatrix_CL(double(*)[TS][2], double(*)[TS][2], double(*)[TS][2]);
void MatrixMulMatrixToMatrix_CLxCL(double(*a)[TS][2], double(*b)[BS][2], double(*c)[BS][2]);
void MatrixMulMatrixToMatrix_CLxCLXCLxCL(double(*a)[BS][2], double(*b)[TS][2], double(*c)[TS][2]);
void MatrixMulVectorToVector_CLxCL(double(*)[TS][2], double(*)[2], double(*)[2]);
void MatrixMulVectorToVector_CLxCL(double(*)[BS][2], double(*)[2], double(*)[2]);
void ScalarMulMatrixToMatrix_CLxCL(double *, double(*)[TS][2], double(*)[TS][2]);
...
void VectorMulMatrixToVector_CLxCL(double(*)[2], double(*)[TS][2], double(*)[2]);
void VectorMulVectorToMatrix_CLxCL(double(*)[2], double(*)[2], double(*)[TS][2]);
