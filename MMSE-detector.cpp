	...
	for (n = 0; n < N; n++) {
		...
		if (MODULATION == QPSK){
			...
			for (m1 = 0; m1 < 4; m1++){
				for (m3 = 0; m3 < 4; m3++){
					u[0] = y[1][0] -
						(H[n][1][0][0] * s_qpsk[m1][0] - H[n][1][0][1] * s_qpsk[m1][1]) -
						(H[n][1][1][0] * s_qpsk[m3][0] - H[n][1][1][1] * s_qpsk[m3][1]);
					u[1] = y[1][1] -
						(H[n][1][0][0] * s_qpsk[m1][1] + H[n][1][0][1] * s_qpsk[m1][0]) -
						(H[n][1][1][0] * s_qpsk[m3][1] + H[n][1][1][1] * s_qpsk[m3][0]);

					d[0] = y[0][0] -
						(H[n][0][0][0] * s_qpsk[m1][0] - H[n][0][0][1] * s_qpsk[m1][1]) -
						(H[n][0][1][0] * s_qpsk[m3][0] - H[n][0][1][1] * s_qpsk[m3][1]);
					d[1] = y[0][1] -
						(H[n][0][0][0] * s_qpsk[m1][1] + H[n][0][0][1] * s_qpsk[m1][0]) -
						(H[n][0][1][0] * s_qpsk[m3][1] + H[n][0][1][1] * s_qpsk[m3][0]);
