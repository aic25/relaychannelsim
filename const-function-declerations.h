...
void CoherentDetection4HD(int data_number, double(*DFT_signal)[N][2], double(*WH)[BS][CL][2], int(*diLLR)[Nd][N_cbps], int(*Decision));
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[TS][BS][2], double(*)[BS][CL][2]);
void MMSE_Weight_Compare(double(*)[TS][BS][2], double(*)[BS][TS][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[BS][CL][2], double(*)[TS][BS][2], double(*e)[NUMBER_OF_STEPS][2]);
void DDWE_Update(int f_index, int(*Decision), int R_index, double(*received_vector)[2], double(*reference_symbol), double(*reference_symbol_bs3), double(*old_weights)[2], double(*new_weights)[2], double(*H)[BS][2], double(*e));
...
void MatrixMulMatrixToMatrix_TSxBSXBSxTS(double(*a)[BS][2], double(*b)[TS][2], double(*c)[TS][2]);
...
double ScalarMulScalar(double(*m1), double(*m2));
double ScalarMulScalar_H(double(*m1), double(*m2));
/*--  matrix_cl.cpp  -------------------------------------------------*/
void MatrixInverse_CLxCL(double(*a)[CL][2], double(*a_inv)[CL][2]);
