...
void CoherentDetection4HD(int data_number, double(*DFT_signal)[N][2], double(*WH)[4][4][2], int(*diLLR)[Nd][N_cbps], int(*Decision));
/*--  MMSE - weight.cpp  ------------------------------------------*/
void MMSE_Weight_Matrix(double(*)[TS][BS][2], double(*)[BS][TS][2]);
void MMSE_Weight_Compare(double(*)[TS][BS][2], double(*)[BS][TS][2]);
/*--  RLS.cpp  ----------------------------------------------------*/
void RLS_initial_weigth(int, int, double(*)[TS][N][2], double(*)[TS][N][2], double(*)[4][4][2], double(*)[TS][BS][2]);
