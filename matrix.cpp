...
void MatrixSubMatrixToMatrix(double(*a)[TS][2], double(*b)[TS][2], double(*c)[TS][2]){
	int i, j, k;
...
void MatrixMulVectorToVector(double(*a)[TS][2], double(*v1)[2], double(*v2)[2]){
	int i, j;
	double sum[2];
...
void MatrixMulVectorToVector2(double(*a)[BS][2], double(*v1)[2], double(*v2)[2]){
	int i, j;
	double sum[2];
...
void ScalarMulMatrixToMatrix(double *s, double(*a)[TS][2], double(*c)[TS][2]){
	int i, j;
...
void VectorMulMatrixToVector(double(*v1)[2], double(*a)[TS][2], double(*v2)[2]){
	int i, j;
...
void VectorMulVectorToMatrix(double(*v1)[2], double(*v2)[2], double(*a)[TS][2]){
	int i, j;
