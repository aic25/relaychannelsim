...
extern double transmitted_sigmat[TS][BS][BURST][2], mse_sum[LOOPN][NUMBER_OF_STEPS];
...
void receiver(double(*received_signal)[BURST][2], int(*rbit)[N_dbps]){
	...
	double received_vector[FILTER_ORDER + 1][2], DFT_signal[PACKETN][TS][N][2], e_freqav[2], e[2];
